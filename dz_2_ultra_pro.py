...
my_digit = 7
user_digit = int(input('Угадайте загаданную мной цифру: '))
while user_digit != my_digit:
  if user_digit > my_digit:
    print('Ваша цифра больше нашей')
  else:
    print('Ваша цифра меньше нашей')
  user_digit = int(input('Попробуйте еще раз: '))
